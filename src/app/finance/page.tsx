      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <header className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[var(--color-border)] bg-[var(--color-panel)] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
          <div className="space-y-1">
            ...
            <h1 className="text-3xl leading-tight text-[var(--color-text)]">Finance Workspace</h1>
            <p className="text-sm text-[var(--color-muted)]">Create, edit, and delete transactions and budgets.</p>
          </div>
