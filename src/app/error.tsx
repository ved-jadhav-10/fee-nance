...
export default function AppError({
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)] px-5 py-12 text-[var(--color-text)] md:px-10">
      <div className="mx-auto w-full max-w-2xl rounded-2xl border border-[var(--color-border)] bg-[var(--color-panel)] p-8 text-center shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
